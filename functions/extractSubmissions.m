% ------------------------------------------------------------------------------------
%---------------  Extraction of EDUCAT submissions  ---------------
% ------------------------------------------------------------------------------------



% create filename
filename =[datestr(now,'yyyy-mm-dd HH-MM')   '_questionnaires ISEN OAS test 11-2021.xlsx'];
 filename = fullfile(pwd,filename);
 i=0;
  while exist(filename, 'file') == 2
      i = i+1;
      filename =[datestr(now,'yyyy-mm-dd HH-MM')   '_questionnaires ISEN OAS test 11-2021_V' int2str(i) '.xlsx'];
        filename = fullfile(pwd,filename);
  end
          ...
          %% Connection to the database
            ...
            %% Get submissions
                    ...
                    sqlquery = ['SELECT TRIM(`submissions`.`id`) AS `submissionID`, '...
                     ...
                     '          WHERE (`submissions`.`id` BETWEEN 600 AND 623) ;'];  
